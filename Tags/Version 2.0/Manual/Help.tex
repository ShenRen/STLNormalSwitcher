...
The buttons ''UnDo''\index{UnDo}, ''Clear History''\index{Clear History}, ''Reset''\index{Reset}, ''Switch All''\index{Switching!All} and ''Switch Selected''\index{Switching!Selected} do just the same as the corresponding menuitems. 
